...
import com.fasterxml.jackson.databind.Module.SetupContext; // This import is needed for it to compile using Kotlin 2.12.0 - If not we get an obscure compiler error
